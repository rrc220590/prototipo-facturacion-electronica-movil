...
class Articles extends React.Component {
    renderProduct = (item, index) => {
        ...
        return ( <
            ...
            { item.price } <
            /Text> <
            Text center size = { 34 } > { item.title } <
            /Text> <
            Text center size = { 16 }
            color = { theme.COLORS.MUTED }
    ...
    renderCards = () => {
        return ( <
            ...
            ImageBackground source = {
                { uri: Images.Products["View article"] } }
            style = {
                [
                    styles.imageBlock,
    ...
    renderAlbum = () => {
        ...
        return ( <
            Block flex style = {
                [styles.group, { paddingBottom: theme.SIZES.BASE * 5 }] } >
            <
            Text bold size = { 16 }
            style = { styles.title } >
            Album <
            ...
            style = {
                { marginTop: theme.SIZES.BASE, flexWrap: "wrap" } } >
            {
                Images.Viewed.map((img, index) => ( <
                    Block key = { `viewed-${img}` }
                    style = { styles.shadow } >
                    <
                    Image resizeMode = "cover"
                    source = {
    ...
    render() {
        return ( <
            ...
            { this.renderCards() } { this.renderAlbum() } <
            /ScrollView> <
            /Block>
        );
    }
